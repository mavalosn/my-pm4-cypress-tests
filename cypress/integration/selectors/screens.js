export default{
    ...
    importPlusBtn:'//i[@class="fas fa-file-import"]//parent::a',
    fileBtn:'input[type="file"]',
    importBtn:'//button[text()[normalize-space()="Import"]]',
    listScreensBtn:'[class="modal-content"] [align="right"] [type="button"]',
    ...
    screenIndex: '[id="screenIndex"] [title="Edit"]',
    ...
    pressCustomHour: '[data-action="showHours"]',
    ...
    pressCustomMinute: '[data-action="showMinutes"]',
