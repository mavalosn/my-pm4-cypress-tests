...
describe("RAOS 1.0.0 - Account Opening - Pre-fill", () => {
    ...
    let taskName;
    let parameterList = {
        pathOption: "Pre-fill and Send to Client",
        isTrust: true,
        users: 1
    };
    ...
    it('RAOS 1.0.0 - Account Application',  () => {
        ...
        cy.url().then((url) => {
            ...
            taskFunctionsSE.accountApplicationSubProcessUserRAOSIntensify(parameterList.users);
        });
    });
