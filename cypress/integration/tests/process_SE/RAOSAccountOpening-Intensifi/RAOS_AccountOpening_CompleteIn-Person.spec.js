...
describe("RAOS 1.0.0 - Account Opening - Complete In-Person with 2 Users", () => {
    ...
    it('RAOS 1.0.0 - Account Application Review', () =>{
        ...
        cy.url().then((url) => {
            ...
            utility.loginBankerUser();
            taskFunctionsSE.accountApplicationReviewSubProcessRAOSIntensify(requestId,parameterList.users);
        });
    });
