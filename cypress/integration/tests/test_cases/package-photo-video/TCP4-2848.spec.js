...
import testData2848 from "../../../../fixtures/test_data/TCP42848.json";
...
describe("Processmaker Test Cases", () => {
    ...
    it('TCP4 - 2848 Verify that the photo/video control, of type Photo can be configured without errors', () =>{
               
        //Step 1: Create Screen 
        navHelper.navigateToScreensPage();
        var timeStamp = new Date().getTime();
        var scree2848 = testData2848.screens[0];  
        var nameScreen = timeStamp + scree2848.name;
        var descriptionScreen = scree2848.description;
        var typeScreen = scree2848.type;
        screen.createScreen(nameScreen, descriptionScreen, typeScreen);
        
        //Step 2: Create versioned screen modeling
        var controlls = scree2848.controlls;
        cy.log(controlls);
        ...
        //Step 4: Create versioned screen modeling
        var controlls2 = scree2848.controlls2;
