...
describe("TCP4 - 2332 Check a sub-process with the multi-instance parallel configuration and the validation of vocabularies", () => {
    ...
    var mainProcessName = 'TCP4-2332 Check a sub-process qa';
    ...
    it('first, second and third validation', () =>{
        navHelper.navigateToProcessPage();
        ...
        cy.url().then(url => {
            ...
            cy.url().then(url => {
                ...
                execution.actionsAndAssertionsOfTCP42332_1(taskName, process_id, subprocess_id, subProcessName,mainProcessName);
            }); 
        });
    });
});